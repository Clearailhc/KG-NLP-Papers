...
2. Probing Linguistic Features of Sentence-Level Representations in Neural Relation Extraction
3. Reasoning with Latent Structure Refinement for Document-Level Relation Extraction
4. TACRED Revisited: A Thorough Evaluation of the TACRED Relation Extraction Task
5. Generalizing Natural Language Analysis through Span-relation Representations
6. Towards Understanding Gender Bias in Relation Extraction
